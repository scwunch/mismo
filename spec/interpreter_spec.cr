  ...
  describe "#run" do
    it "works" do
      program = <<-MISMO
        ...
        MISMO
      Interpreter.run(program, file_path: __FILE__, starting_line: __LINE__).should eq(Val.new(25))
    end
        ...
        def main String:
          ...
          if r is 
            ...
            _: 
              "some other color"
        MISMO
      Interpreter.run(program, file_path: __FILE__, starting_line: __LINE__).should eq(Val.new("some other color"))
    end
  end
end
...
describe Ast::Node do
  describe "#==" do
    it "returns true if the nodes are equal type and equal fields" do
      ...
      Ast::Binop.new(loc, Ast::Int.new(loc, 123), Operator::Add, Ast::Int.new(loc, 456)).should eq(Ast::Binop.new(loc, Ast::Int.new(loc, 123), Operator::Add, Ast::Int.new(loc, 456)))
      ...
      Ast::DotNode.new(loc, Ast::Int.new(loc, 123), "x").should eq(Ast::DotNode.new(loc, Ast::Int.new(loc, 123), "x"))
      Ast::DotNode.new(loc, "x").should eq(Ast::DotNode.new(loc, "x"))
      Ast::Call.new(loc, Ast::Int.new(loc, 123), "x", [Ast::Int.new(loc, 456)]).should eq(Ast::Call.new(loc, Ast::Int.new(loc, 123), "x", [Ast::Int.new(loc, 456)]))
      ...
      Ast::ForLoop.new(loc, Ast::Int.new(loc, 123), Ast::Int.new(loc, 456), Ast::Int.new(loc, 789)).should eq(Ast::ForLoop.new(loc, Ast::Int.new(loc, 123), Ast::Int.new(loc, 456), Ast::Int.new(loc, 789)))
      Ast::WhileLoop.new(loc, Ast::Int.new(loc, 123), Ast::Int.new(loc, 456)).should eq(Ast::WhileLoop.new(loc, Ast::Int.new(loc, 123), Ast::Int.new(loc, 456)))
